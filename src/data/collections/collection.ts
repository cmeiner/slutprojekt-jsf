...
export const collectionData: collectionDataItem[] = [
  ...
  {id: 5,
    name: "DCNFT",
    description: "DC SuperNFT, köp och få en blowie av Meiner",
    volumeTraded: 30,
    floorPrice: 73,
    ...
    NFTS: [
      {
        ...
        price: 12,
        description: "Clark Kent's own SUPER NFT",
        count: 1,
        collectionID: 5,
      },
      {
        ...
        price: 12,
        description: "Bruce Wayne's dark and shadowy NFT",
        count: 1,
        collectionID: 5,
      },
      {
        ...
        price: 12,
        description: "Princess Diana's NFT that represents truth, justice and equality for all",
        count: 1,
        collectionID: 5,
      },
      {
        ...
        price: 12,
        description: "The fastest NFT alive",
        count: 1,
        collectionID: 5,
      },
      {
        ...
        price: 12,
        description: "Green Lantern's NFT, almost as powerful as his ring",
        count: 1,
        collectionID: 5,
      },
      {
        ...
        price: 12,
        description: "The Royal NFT of Atlantis",
        count: 1,
        collectionID: 5,
      },
    ],
  ...
  {id: 6,
    ...
    NFTS: [
      ...
      },
      {
        ...
        price: 12,
        description: "Get a taste of the tropics from Nocco's Caribbean NFT",
        count: 1,
        collectionID: 6,
      },
      {
        ...
        price: 12,
        description: "GRRM's favorite: A Song of Ice and Soda",
        count: 1,
        collectionID: 6,
      },
      {
        ...
        price: 12,
        description: "The instant 2022 summer classic, Juicy B NFT",
        count: 1,
        collectionID: 6,
      },
      {
        ...
        price: 12,
        description: "When life gives you lemons, make Limón NFT",
        count: 1,
        collectionID: 6,
      },
      {
