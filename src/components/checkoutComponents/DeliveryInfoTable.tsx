  ...
  return (
    <div>
      <table style={{ gap: "1rem" }}>
        ...
        <tr>
          <td>Address</td>
          <td style={{ paddingLeft: "1rem" }}>{props.deliveryInfo.address}</td>
        </tr>
        <tr>
          <td>Zipcode</td>
          <td style={{ paddingLeft: "1rem" }}>{props.deliveryInfo.zipCode}</td>
        </tr>
        <tr>
          <td>City</td>
        ...
        <tr>
          <td>Country</td>
          <td style={{ paddingLeft: "1rem" }}>{props.deliveryInfo.country}</td>
        </tr>
        <tr>
          <td>Delivery</td>
          <td style={{ paddingLeft: "1rem" }}>
